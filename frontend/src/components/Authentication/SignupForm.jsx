    ...
    const registerUser = e =>{
        ...
        if(checkIfReady() && passwordCheck()){
            const formData = {
                ...
                country: $(".form-side #country").val(),
                phone_number: $(".form-side input[name='mobile-number']").val(),
                home_address: $(".form-side input[name='home-address']").val()
            }
            ...
            showMessage('error', 'There Are Incorrect Values or Empty Fields')
            setLoading(false);
        }
    }
    ...
    return( registered ?
        ...
        <div className="form-side">
            <form onSubmit={ registerUser }>
                ...
                <div>
                    <label htmlFor="wallet-address">Your Home Address</label>
                    <input type="text" name="wallet-address" id="wallet-address" placeholder="Your Home Address [Optional]"/>
                </div>
                <div>
